...
// let userName;
// let catchNewMessage;
// localeOK = new Boolean(false);

// function verifyUser() {
//     if (!window.localStorage.getItem('user')) {
//         userName = prompt("Digite seu nome de usuário do Ocean:");
...
//     if (e.pageX < 518.41  && e.pageY > 126 && e.pageX > 98) { 
//         console.log("lugar")
//         localeOK = true;
//     }else {
//         console.log("Outrolugar")
//         localeOK = false;
//     }
// }

// var contador = 1;
// // while(!document.getElementsByClassName("_1-iDe _1xXdX")[0]){
...
// //     });
// // }
// // var temp1 = setInterval(teste(), 7000);
...
//                 if (document.getElementsByTagName("span")[i].getAttribute("class") &&
//                     (document.getElementsByTagName("span")[i].getAttribute("class") == "_1wjpf _3NFp9 _3FXB1")) {
//                     contactName = document.getElementsByTagName("span")[i].getAttribute("title");
//                 }
//             }
//             for (let i = 0; i < document.getElementsByClassName('_3FXB1 selectable-text invisible-space copyable-text').length; i++) {
//                 catchNewMessage = document.getElementsByClassName('_3FXB1 selectable-text invisible-space copyable-text')[i].outerText;
//             }
//             console.log(catchNewMessage);
...
// waitPageLoad();
//teste();
//vW7d1 message-in focusable-list-item
//vW7d1 message-out focusable-list-item

//_3FXB1 selectable-text invisible-space copyable-text --> nome do ultimo span antes do texto


// Verificando os roles
var conole = console;
